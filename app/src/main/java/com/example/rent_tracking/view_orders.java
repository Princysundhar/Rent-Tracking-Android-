...
public class view_orders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        li = findViewById(R.id.listview6);


        sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        sh.getString("ipaddress","");
        url = sh.getString("url","") + "android_view_orders";
...
//                                }
                                ...
                                li.setAdapter(new custom_view_orders(getApplicationContext(),order_id,date,status,amount,store_name,payment_status));
